      ...
      <div className="order-item-card">
        ...
        <div className="order-item-card__info-container">
          <span className="order-item-card__item-name">
            {this.state.orderItem.item.name} {this.state.orderItem.item.pickedSize ? `(${this.state.orderItem.item.pickedSize.name.toUpperCase()}-$${parseFloat(this.state.orderItem.item.pickedSize.price).toFixed(2)})` : null}
          </span>
